...
public class FormularioPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        miCadastrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/cadastrar.png"))); // NOI18N
        miCadastrar.setMnemonic('c');
        miCadastrar.setText("Cadastrar Medicamento");
        miCadastrar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                miCadastrarActionPerformed(evt);
            }
        });
        mOperacoes.add(miCadastrar);
        mOperacoes.add(jSeparator1);

        miSair.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        miSair.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/sair2.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(590, 421));
